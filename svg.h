...
void svg_pixelDepth(svg* psvg, int x, int y, unsigned int depth_value);
// --------------------------------------------------------
...
void svg_pixelDepth(svg* psvg, int x, int y, unsigned int depth_value){
      ...
      index=depth_value;
      char *COLOR="#000000";
      //Write statement to convert depth to index
      	 if(index>0){
   switch (index) {
    case 0 ... 255 :
    COLOR=WHITE;
